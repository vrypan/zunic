...
pub fn build(b: *std.Build) void {
    ...
    const root = generated.addCopyFile(b.path("zunic-wrap.zig"), "zunic-wrap.zig");
    ...
    const executable = b.addExecutable(.{ .name = "zunic-wrap-bench", .root_module = module });
    ...
    b.step("test", "Test Zunic wrapping over the shared corpora").dependOn(&b.addRunArtifact(tests).step);
}
