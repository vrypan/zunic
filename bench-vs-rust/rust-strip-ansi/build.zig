...
pub fn build(b: *std.Build) void {
    ...
    const root = generated.addCopyFile(b.path("zunic-strip-ansi.zig"), "zunic-strip-ansi.zig");
    ...
    const executable = b.addExecutable(.{ .name = "zunic-strip-ansi-bench", .root_module = module });
    ...
    b.step("test", "Test stripping with reused and allocated storage").dependOn(&b.addRunArtifact(tests).step);
}
